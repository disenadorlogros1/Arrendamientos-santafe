                  ...
                  <div style={{ marginTop: 24 }}>
                    ...
                    <div ref={detailsRef} style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', columnGap: 24, rowGap: 0 }}>
                      {[
                        ...
                        { icon: '/icons/icon-parking-red.svg',   label: 'Parqueaderos',      value: String(property.parking),          show: (property.parking ?? 0) > 0 },
                        { icon: '/icons/icon-parking-red.svg',   label: 'Garajes',           value: String(property.garage),           show: (property.garage ?? 0) > 0 },
