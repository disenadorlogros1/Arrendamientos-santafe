    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-[550px] md:h-[720px] flex items-center justify-center overflow-hidden bg-gradient-to-br from-gray-900 to-gray-800" style={{ marginTop: '-86px' }}>
        ...
        <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-4xl" ref={titleRef}>
          ...
          <div ref={ctaBtnRef} className="mt-8" style={{ opacity: 0 }}>
            <a
              href={WHATSAPP_URL}
              target="_blank"
        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-8 md:space-y-12 mb-12">
            {[
              ...
              <ScrollReveal key={step.number} delay={index * 0.1} y={20}>
          ...
          <ScrollReveal y={20} className="text-center space-y-6">
            <a
              href={WHATSAPP_URL}
              target="_blank"
              rel="noopener noreferrer"
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <ScrollReveal key={item.title} delay={index * 0.1} y={20}>
