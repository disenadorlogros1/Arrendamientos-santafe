...
const EVENTS = [
  ...
  { year: '2017', title: 'Más cerca de nuestros clientes',        body: 'Con la apertura de la sede en Envigado, Santa Fe amplía su presencia y fortalece su cercanía con nuevas zonas del Valle de Medellín.',                                                        layers: L2017 },
...
export default function Historia60Page({ onNavigate }: Props) {
      ...
      for (let i = 0; i < N - 1; i++) {
        ...
        const tl = gsap.timeline({
          scrollTrigger: {
            ...
            start: `top+=${(ic * 3 + 2) * window.innerHeight} top+=${startOffset}`,
            end:   `top+=${(ic * 3 + 3) * window.innerHeight} top+=${startOffset}`,
            scrub: 1.2,
  ...
  return (
    <div style={{ background: '#fff' }}>
      ...
      {!isMobile && (
      <div ref={wrapperRef} style={{ height: `${N * 300}dvh`, background: '#fff' }}>
        <div
          style={{
