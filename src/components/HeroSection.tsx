  ...
  return (
    <section className="relative w-full h-[calc(100vh-100px)] lg:h-[70vh] flex flex-col items-center justify-center overflow-hidden">
      ...
      <div
        ...
        ref={titleRef}
      >
        <h1 className="hero-title-split text-3xl sm:text-4xl lg:text-5xl text-white tracking-tight" style={{ fontFamily: "'Avenir Next Ultra Light', 'Avenir LT Pro 65 Medium', 'Avenir', 'Outfit', system-ui, sans-serif", fontWeight: 200, lineHeight: '0.65' }}>
